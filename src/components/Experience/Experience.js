                ...
                <div className="row">
                    ...
                    <div className="col-md-6 col-sm-12">
                        <div className="workArea">
                            ...
                            <h6>Since October 2021 to Continue</h6>
                            <p>I have been working as a front end developer since october 2021 at BYSL GLOBAL TECHNOLOGY . I am a hardworking ,dedicated IT person. I have completed more than 10 projects which are fully professional.</p>
                        </div>
                    </div>
                    <div className="col-md-6 col-sm-12">
